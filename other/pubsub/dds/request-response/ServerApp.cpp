...
void ServerApp::create_participant()
{
    ...
    // Enabling UDPv4 Transport
   /* auto udp_transport = std::make_shared<eprosima::fastdds::rtps::UDPv4TransportDescriptor>();
    udp_transport->sendBufferSize = 9216;
    udp_transport->receivedBufferSize = 9216;
    udp_transport->non_blocking_send = true;
    // link transport layer to the participant
    ...
    eprosima::fastdds::rtps::IPLocator::setIPv4(locator, "172.16.30.49");
    eprosima::fastdds::rtps::IPLocator::setPhysicalPort(locator, 5100);
    // logic port value setting
