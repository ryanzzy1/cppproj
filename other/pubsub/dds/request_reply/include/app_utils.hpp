...
public:
    ...
    bool is_matched(const rtps::GuidPrefix_t& guid_prefix)
    {
...
struct TypeConverter
{
    ...
    static std::string to_string(const rtps::GuidPrefix_t& guid_prefix)
    {
    ...
    static std::string to_string(const rtps::ParticipantDiscoveryStatus& info)
    {
